 ...
 */
export function getSelectedTranscriptionService(): TranscriptionService | undefined {
	const selectedServiceId = settings.value['transcription.selectedTranscriptionService'];
